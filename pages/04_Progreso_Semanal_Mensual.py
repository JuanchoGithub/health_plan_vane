...
def progreso():
    ...
    if user_id:
        ...
        if exercise_logs:
            ...
            start_date = st.date_input("Fecha de Inicio", value=pd.to_datetime("2025-01-01"))
            end_date = st.date_input("Fecha de Fin", value=pd.to_datetime("2025-05-10"))
            ...
            comparison_week = st.selectbox("Seleccione una Semana para Comparar", weekly_summary["Semana"])
